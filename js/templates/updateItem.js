...
function updateItem({ todo, category, status, uid, dialog }) {
	dialogElem = dialog
...
`
	...
	item.querySelector('#edit-form').addEventListener('submit', onUpdateItem, false)
